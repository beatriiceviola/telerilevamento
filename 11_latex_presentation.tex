...
% Cercando "Beamer themes and colors" possiamo vedere i temi a sinistra
% e i colori sulla riga in alto 
...
the presentation will be on:
    ...
    \end{itemize}
\end{frame}
%con la funzione \pause usata prima gli ultimi due punti dell'elenco mi appaiono in altre slide,
%un po' come una sorta di animazione
...
\begin{equation}
    ...
    % \displaystyle = mi mette la i=1 sotto il simbolo sommatoria e la N sopra 
